/**
 * Job: Rappi → Clients
 * Consulta BigQuery por órdenes Rappi sin cliente en JS_Designs.Clients
...
async function main(): Promise<void> {
  console.log('Job Rappi/Clients: querying BigQuery...');
  ...
  console.log('Job Rappi/Clients finished.');
}
