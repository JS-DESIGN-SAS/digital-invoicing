/**
 * Job: Meli (Mercado Libre) → Clients
 * Consulta BigQuery por órdenes Meli sin factura ni cliente y crea los contactos en Alegra.
 */
...
async function main(): Promise<void> {
  console.log('Job Meli/Clients: querying BigQuery...');
  ...
  console.log('Job Meli/Clients finished.');
}
